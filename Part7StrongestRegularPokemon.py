...
for line in pokedex:
    ...
    if poke.total_power()>highest and not (poke.Legendary or poke.Mega):
        print(poke.Name, poke.total_power())
        highest=poke.total_power()
        strongest_nonLegendary=poke.Name

print(strongest_nonLegendary,highest)
