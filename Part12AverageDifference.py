...
#Rounded to the nearest integer, how much higher is
#the average sum of all six stats among Mega Pokemon than
#their non-Mega versions? Note that Mega Pokemon share the
#same Number (the first column) as their non-Mega versions,
...
for line in pokedex:
    ...
    if poke.Mega and " Y" not in poke.Name:  #Need to remove the 2nd mega version. The 2nd mega total power throws the data off.
                                             #The total power of the Mega X and Mega Y are the same.
        print(poke.Name,poke.total_power())
        count+=1
        MegaTotalPower+=poke.total_power()
        average=MegaTotalPower/count
        numberListMega.append(poke.Number)
        #print(poke.Name)
print("Number of Megas:",count)
#print("MegaTotalPower:",MegaTotalPower)
print("AverageMegaTotalPower:",average)
#print("MegaCountLocation:",numberListMega)
...
for line in pokedex:
    ...
    if poke.Number in numberListMega and not poke.Mega:
        count+=1
        print(poke.Name,poke.total_power())
        NonMegaTotalPower+=poke.total_power()
        averageNonMegaPower=NonMegaTotalPower/count


print("Number of Non-Mega:",count)
#print("NonMegaTotalPower:",NonMegaTotalPower)
print("Averge Non-Mega Power:",averageNonMegaPower)

difference=round(average-averageNonMegaPower)
