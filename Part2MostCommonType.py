...
for line in pokedex:
    ...
    if poke.Type1 not in TypeCount:
        TypeCount[poke.Type1]=0
    TypeCount[poke.Type1]+=1

    if poke.Type1 not in Type1Count:
        Type1Count[poke.Type1]=0
    Type1Count[poke.Type1]+=1

    if poke.Type2 not in TypeCount and poke.Type2!="":
        TypeCount[poke.Type2]=0

    if poke.Type2 not in Type2Count and poke.Type2!="":
        Type2Count[poke.Type2]=0
    ...
    if poke.Type2=="":
        ...
        TypeCount[poke.Type2]+=1
        Type2Count[poke.Type2] += 1
