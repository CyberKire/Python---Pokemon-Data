...
#submission here.
#Excluding Pokemon that are either Mega or Legendary,
...
for line in pokedex:
    ...
    if poke.Defense>highestD and not(poke.Mega or poke.Legendary):
        print(poke.Name)
        highestD=poke.Defense
        pokeHighestD=poke.Name
print(pokeHighestD)
print(highestD)
